...
const JobComponent = () => {
  ...
  return (
    <div className={isLoaded?'w-screen min-h-screen  bg-gray-50 px-10 py-24':""}>
      {isLoaded ? <>
        <div className=' flex relative w-full items-start justify-center'>
          <div className='w-[50%] flex flex-col gap-y-10 '>
            <p className='text-5xl poppins-semi-bold px-5 py-2 text-zinc-900' >{jobData.jobTitle}</p>
            ...
            <div className='text-xl flex items-center gap-x-10 poppins-medium text-zinc-700 relative px-5 py-5 border-2  w-[60%] rounded-lg justify-between'>
              <p className='absolute px-1 -top-4 bg-gray-50 poppins-medium text-[1rem]'>Job expectations</p>
            ...
            <div className='poppins-medium text-xl px-5 py-5 gap-x-10 rounded-lg  border-2 border-[#8f92ff9c] text-[#686df8] max-w-[45%] flex items-center  relative'>
            ...
            <div className='relative px-5 py-9 w-full rounded-2xl border-2  gap-y-5 flex flex-col'>
              <p className='poppins-medium absolute -top-4 px-1 bg-gray-50'>Job requirements</p>
              <p className='w-full text-[1.025rem] poppins-light p-7 rounded-lg'>{jobData.jobDescription}</p>
              <div className='flex items-center relative px-7'>
                <p className='poppins-semi-bold text-xl pr-3 '>Skills :</p>
                <div className='w-[90%] flex items-center gap-x-5'>
                  {jobData.jobTags.map((value, index) => (<span className='poppins-medium text-lg px-3 py-1 rounded-lg bg-[#dddefd98] border-2 border-[#8f92ff9c] text-[#686df8] max-w-[25%] flex items-center justify-center' key={index}>{value}</span>))}
                </div>
              </div>
            </div>
