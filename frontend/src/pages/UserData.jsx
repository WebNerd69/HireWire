...
const UserData = () => {
  ...
  return (
    <div className='p-24 flex flex-col gap-y-10 bg-gray-50'>
      {/* personal info */}
      <div className='w-full px-10 py-10 rounded-xl border-2 relative flex flex-col justify-center gap-y-10'>
        ...
        <div className='w-full flex items-center justify-between'>
          ...
          <div className='px-5 py-2 border-2 w-[30%] relative rounded-lg flex item-center'>
        ...
        <div className='w-[65%] flex items-center justify-between'>
          ...
          <div className='px-5 py-2 border-2 w-[46%] relative rounded-lg flex items-center'>
            <p className='text-sm text-zinc-900 absolute -top-3 bg-gray-50 px-2 poppins-medium'>
              Phone
            </p>
      ...
      <div className='w-full px-10 py-10 rounded-xl border-2 relative flex flex-col justify-center gap-y-10'>
        ...
        <div className='w-full flex items-center justify-between'>
          ...
          <div
            ...
            className='cursor-pointer px-5 py-3 border-2 w-[30%] relative rounded-lg flex items-center '
          >
            <p className='text-sm text-zinc-900 absolute -top-3 bg-gray-50 px-2 poppins-medium'>
              LinkedIn
            </p>
      ...
      {/* skills */}
      <div className='px-5 py-2 border-2 w-[45%] relative rounded-xl min-h-20 flex items-center'>
      ...
      <div className='w-full px-10 py-10 rounded-xl border-2 relative flex flex-col justify-center gap-y-10'>
        ...
        {/* project 1 */}
        <div className='w-full flex items-center justify-between'>
          <div className='px-5 py-5 border-2 w-[30%] relative rounded-lg flex item-center min-h-14'>
